    ...
    <div className='flex '>
        ...
        <div className='w-[20%] p-4 hidden md:block'>
            <div>
                ...
                <ul className='my-4 space-y-3'>
                    <li className='text-[rgba(89,103,128,100%)] font-semibold'> <input type="checkbox" /> Corolla <span className='text-[rgba(144,163,191,100%)] text-[14px]'>(10)</span></li>
                    <li className='text-[rgba(89,103,128,100%)] font-semibold'> <input type="checkbox" /> Honda <span className='text-[rgba(144,163,191,100%)] text-[14px]'>(12)</span></li>
                    <li className='text-[rgba(89,103,128,100%)] font-semibold'> <input type="checkbox" /> Civic <span className='text-[rgba(144,163,191,100%)] text-[14px]'>(16)</span></li>
                    <li className='text-[rgba(89,103,128,100%)] font-semibold'> <input type="checkbox" /> Toyota <span className='text-[rgba(144,163,191,100%)] text-[14px]'>(20)</span></li>
                    <li className='text-[rgba(89,103,128,100%)] font-semibold'> <input type="checkbox" /> BMW <span className='text-[rgba(144,163,191,100%)] text-[14px]'>(14)</span></li>
                    <li className='text-[rgba(89,103,128,100%)] font-semibold'> <input type="checkbox" /> Mercedes <span className='text-[rgba(144,163,191,100%)] text-[14px]'>(14)</span></li>
                </ul>
            </div>
            ...
            <div className='mt-4'>
                ...
                <h1 className='text-[rgba(89,103,128,100%)] font-semibold text-[14px]'>Max. Rs.15000.00</h1>
            </div>
        ...
        <div className='w-[80%] bg-[#F6F7F9] mx-auto'>
            <div className='p-4 w-[100%]  flex flex-col h-fit lg:flex-row justify-between'>
                <div className='lg:w-[45%] px-4 py-3 bg-[rgba(90,180,250,100%)] '>
                ...
                <div className='w-full lg:w-[45%] px-4 py-3 bg-[rgba(90,180,250,100%)]'>
                    <div className='flex gap-4'>
                        <input type="radio" checked/>
            ...
            <div className='gap-4 flex flex-col md:flex-row md:flex-wrap justify-between '>
                ...
                <div className='bg-white rounded-lg w-fit p-3 shrink-0 mx-auto'>
                    ...
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>Corolla</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.2500.00/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                            <h1 className='text-[rgba(89,103,128,100%)] line-through font-[14px]'>Rs.5000.0</h1>
                        </div>
                ...
                <div className='bg-white rounded-lg w-fit p-3 shrink-0 mx-auto'>
                    ...
                    {/* div for car category heading */}
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>BMW</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.10000.00/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                        </div>
                ...
                <div className='bg-white rounded-lg w-fit p-3 shrink-0 mx-auto'>
                    ...
                    {/* div for car category heading */}
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>Toyota</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.8000.00/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                        </div>
                ...
                <div className='bg-white rounded-lg w-fit p-3 shrink-0 mx-auto'>
                    ...
                    {/* div for car category heading */}
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>Mercedes</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.15000.00/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                ...
                <div className='bg-white rounded-lg w-fit p-3 hidden md:block shrink-0 mx-auto'>
                    ...
                    {/* div for car category heading */}
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>Honda</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.6000.00/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                        </div>
                        <button className='bg-[#3563E9] text-white rounded-md px-6 py-2'><Link href={"/billing"}>Rent Now</Link></button>
                ...
                <div className='bg-white rounded-lg w-fit p-3 hidden md:block shrink-0 mx-auto'>
                    ...
                    {/* div for car category heading */}
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>Civic</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.3000.00/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                        </div>
                        <button className='bg-[#3563E9] text-white rounded-md px-6 py-2'><Link href={"/billing"}>Rent Now</Link></button>   
                    </div>
                ...
                <div className='bg-white rounded-lg w-fit p-3 hidden md:block shrink-0 mx-auto'>
                    ...
                    {/* div for car category heading */}
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>fortuner</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.9000.00/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                        </div>
                        <button className='bg-[#3563E9] text-white rounded-md px-6 py-2'><Link href={"/billing"}>Rent Now</Link></button>   
                    </div>
                ...
                <div className='bg-white rounded-lg w-fit p-3 shrink-0 mx-auto'>
                    ...
                    <div className='flex justify-between'>
                        <div>
                            <h1 className='font-bold text-[rgba(26,32,44,100%)] text-[16px]'>Sport</h1>
                        </div>
                        <div>
                            <button><Image src={redheart} alt='loading' width={20} height={20} /></button>
                        </div>
                    ...
                    {/* div for car category heading */}
                    <div>
                        <h1 className='text-[rgba(89,103,128,100%)] font-bold text-[14px]'>Farari</h1>
                    </div>
                    ...
                    <div className='flex justify-between items-center my-2'>
                        <div>
                            <h1 className='font-[PlusJakartaSans] font-bold text-[20px]'>Rs.16000.0/<span className='text-[14px] text-[rgba(26,32,44,100%)]'>day</span></h1>
                        </div>

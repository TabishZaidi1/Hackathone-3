...
const Herosection =  () => {
  ...
  return (
    ...
    <div className='px-[40px] py-[32px] md:flex md:justify-between bg-[#B0B0B0]'>

        {/* first child div */}
        <div className="bg-[rgba(90,180,250,100%)] lg:w-[48%] h-[350px] rounded-xl bg-[url('/BG.png')] bg-cover bg-center relative">
            <div className='p-6'>
         ...
         {/* second child div */}
        <div className="bg-[rgba(90,180,250,100%)] lg:w-[48%] h-[350px] rounded-xl bg-[url('/Rectangle.png')] bg-repeat bg-center relative hidden md:block">
            <div className='p-6'>
